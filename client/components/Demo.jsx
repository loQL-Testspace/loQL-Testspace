...
const Demo = () => {
  ...
  return (
    <div>
      ...
      <button className="queries" id="query3" onClick={() => performGQLQuery('https://beta.pokeapi.co/graphql/v1beta', query3)}>Simple Pokemon Query </button>
      <button className="queries" id="query4" onClick={() => performGQLQuery('https://beta.pokeapi.co/graphql/v1beta', query4)}>Nested Pokemon Query </button>
