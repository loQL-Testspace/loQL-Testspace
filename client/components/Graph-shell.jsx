...
<div className={"bar-container"}><div className={"bar1"}>&nbsp;</div><div>{(uncachedSpeed/1000)} sec</div></div>

<div className={"cache-title"}>Fetched from cache</div>

<div className={"bar-container"}><div className={"bar2"}>&nbsp;</div><div>{(cachedSpeed/1000)} sec</div></div>
